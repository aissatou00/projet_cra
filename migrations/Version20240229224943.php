 ...
 */
final class Version20240229224943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       // $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, personne_id INT NOT NULL, mobile VARCHAR(15) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, birthday DATE NOT NULL, INDEX IDX_5D9F75A1AE80F5DF (department_id), INDEX IDX_5D9F75A1A21BD112 (personne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
